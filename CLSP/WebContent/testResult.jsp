...
<style>
  ...
  #A5C2E3 0% <%= (testDto.getEatingHabits()*100/testDto.getAllScore()) %>%, 
  #EA3323 <%= (testDto.getEatingHabits()*100/testDto.getAllScore()) %>% <%= (testDto.getEatingHabits()*100/testDto.getAllScore()) + (testDto.getLifeHabits()*100/testDto.getAllScore()) %>%, 
  #F9DA78 <%= (testDto.getEatingHabits()*100/testDto.getAllScore()) + (testDto.getLifeHabits()*100/testDto.getAllScore()) %>% <%= (testDto.getEatingHabits()*100/testDto.getAllScore()) + (testDto.getLifeHabits()*100/testDto.getAllScore()) + (testDto.getExercise()*100/testDto.getAllScore()) %>%, 
  #B1D095 <%= (testDto.getEatingHabits()*100/testDto.getAllScore()) + (testDto.getLifeHabits()*100/testDto.getAllScore()) + (testDto.getExercise()*100/testDto.getAllScore()) %>% 100%);
  border-radius: 50%;
  }
</style>
</head>
