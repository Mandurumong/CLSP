            ...
            <div class="tabs">
              ...
              <div class="tab-content" id="tab1">
                 ...
                 <div id = "index_LSD">
                 	...
                 	<button type="button"><a href="#increase">당뇨병의 유병률 현황</button>
                 	<button type="button"><a href="#cause">유병률 현황의 원인</button>
                 </div>
				 ...
				 <p>제 1형 당뇨병은 췌창의 베타세포가 파괴되어 인슐린이 분비되지 않는 병입니다.<br>
				 	대부분 자기면역기전에 의해 발생하므로 베타세포를 포함하는 췌도세포에 대한 특이 자가항체 검사가 양성으로 나오거나,<br>
				 	...
				 	케톤산증의 병력이나 고혈당과 함께 혈액이나 소변에서 케톤이 검출되면 제 1형 당뇨병을 의심하는 단서가 될 수 있습니다.
				 </p>
				 <p>2. 제 2형 당뇨병</p>
				 <p>제 2형 당뇨병은 몸의 인슐린 저항성이 커지면서 인슐린의 작용이 원활하지 않고 상대적으로 인슐린 분비의 장애가 생겨 혈당이 올라가는 병입니다.<br>
				 	한국인 당뇨병의 대부분이 제 2형 당뇨병입니다. 보통 40세 이상에서 발생하지만 그보다 젊은 연령에서도 생길 수 있으며, 최근에는 30세 이하의 젊은 제 2형 당뇨병 환자가 늘고 있습니다.<br>
